                    ...
                    <div className="card shadow border-left-success py-2">
                        <div className="card-body">
                            <button className="btn" onClick={()=>
                                SetShowDropDown(!showDropdown)}>Afficher/Masquer</button>
                            { showDropdown ?
                    ...
                    <div className="card shadow mb-4">
                        <div className="card-header d-flex justify-content-between align-items-center">Traduction
                            <div className="dropdown no-arrow">
                                <button className="btn btn-link btn-sm dropdown-toggle" data-toggle="dropdown"
                                ...
                                <div className="dropdown-menu shadow dropdown-menu-right animated--fade-in" role="menu">
                                    <p className="text-center dropdown-header">dropdown header:</p><a
                                        className="dropdown-item" role="presentation" href="#">&nbsp;Action</a><a
                                        className="dropdown-item" role="presentation" href="#">&nbsp;Another action</a>
            ...
            <div className="row">
                <div className="col-lg col-xl">
                    <div className="card shadow">
                        <div className="card-header d-flex justify-content-between align-items-center">Graphique du
                            Covid en France</div>
                        <div className="card-body">
                            <Graph />
                        </div>
